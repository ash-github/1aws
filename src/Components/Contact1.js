...
function Contact1() {
  ...
  function handleSubmit(e) {
    ...
    // URL encode the message to ensure it's safe to use in a URL
    const encodedMessage = encodeURIComponent(message);

    // WhatsApp phone number (replace with the desired phone number in international format)
    const phoneNumber = '+919975288300'; // Replace with your number
    ...
    // Optionally, reset the form or handle any UI updates
    setFormData({ name: "", email: "", phone: "", subject: "", message: "" });
    setResponseMessage("Your message has been sent to WhatsApp.");
    setLoading(false);
  }
